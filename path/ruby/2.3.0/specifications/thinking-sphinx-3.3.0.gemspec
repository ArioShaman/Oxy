# -*- encoding: utf-8 -*-
# stub: thinking-sphinx 3.3.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<riddle>, [">= 2.0.0"])
      s.add_development_dependency(%q<appraisal>, ["~> 1.0.2"])
      s.add_development_dependency(%q<combustion>, ["~> 0.5.4"])
      ...
      s.add_dependency(%q<riddle>, [">= 2.0.0"])
      s.add_dependency(%q<appraisal>, ["~> 1.0.2"])
      s.add_dependency(%q<combustion>, ["~> 0.5.4"])
